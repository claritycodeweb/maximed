    ...
    <>
      ...
      <section className="pt-[84px] pb-10">
        <div className="w-[min(100%-40px,1120px)] max-[640px]:w-[min(100%-28px,1120px)] mx-auto">
          <h1 className="m-0 mb-3.5 text-[clamp(2rem,4vw,3rem)] leading-[1.06] tracking-[-0.03em]">{t('termsAndConditions.title')}</h1>
          <p className="m-0 w-[min(100%,760px)] text-muted">{t('termsAndConditions.operator')}</p>
